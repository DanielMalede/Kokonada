...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(?:@react-native|react-native|@reduxjs/toolkit|immer|redux|reselect|redux-thunk|react-redux|zustand|@react-navigation|react-native-screens|react-native-haptic-feedback)/)',
  ],
};
